...
_Generated: 2026-07-26T07:25:54.154Z_
...
Workspace `mcp.json` _(folder: SFC_frontend)_

- **d:\SFC\SFC_frontend\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\brijk\.claude.json** — _File missing_
